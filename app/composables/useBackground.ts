...
const useBackground = () => {
  ...
  const random_item = (() => {
    const items = [
      'https://images.pexels.com/photos/4861353/pexels-photo-4861353.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      'https://images.pexels.com/photos/5269507/pexels-photo-5269507.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
